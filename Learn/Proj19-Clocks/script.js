...
function setTime(){
    ...
    hourHand.style.transform = `translate(-50%, -100%) rotate(${scale(hours, 0, 23, 0, 360)}deg)`;
    ...
    dateShow.innerHTML = `${days[day]}, ${months[month]} <span class="circle">${time.getDate()}</span>`;
}
